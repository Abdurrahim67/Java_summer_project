...
public class HA160 extends FMercedes{
     ...
     */
    public static void main(String[] args) { // MX3Dizel class'indan sonra olusturuldu
        ...
        EToyota arb4= new GCorolla(); // Gcorolla class'i concret class obje üretilebilir.


       // List<String> list1 = new List<String>(); // List abstract , obje üretemeyiz. Child class'tan ( ArrayList) yardim aliriz
