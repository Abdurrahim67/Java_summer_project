...
public class JavaMathClassMethods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("3.5 sayisinin alt tamsayiya yuvarlama = " + Math.floor(3.5)); //

        // 3//Math.random() : double veri tipine sahip olarak algılar ve 0-1 arasında rastgele sayı üretir. (Math.random())
