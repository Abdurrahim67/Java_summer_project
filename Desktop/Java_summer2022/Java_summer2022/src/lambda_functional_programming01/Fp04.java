...
public class Fp04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("get7den100Toplam01() = " + get7den100Toplam01());
        System.out.println("get7den100Toplam02() = " + get7den100Toplam02());
        System.out.println("get2den11rCarpim() = " + get2den11rCarpim());
        System.out.println("faktoriyelHesapla() = " + faktoriyelHesapla(10));
        System.out.println("verilenIkiSayiArasindakiCiftSayilarinToplamini() = " + verilenIkiSayiArasindakiCiftSayilarinToplamini(11, 7));
    ...
    //1.yol
    public static int get7den100Toplam01() {
    ...
    public static int get2den11rCarpim() {
