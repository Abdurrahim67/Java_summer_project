...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("kelimeKursAdlarirIcindeVarmi() = " + kelimeKursAdlarirIcindeVarmi(coursesList, "X"));
        System.out.println("ortalamasıEnYuksekKursunAdiniYazdir() = " + ortalamasıEnYuksekKursunAdiniYazdir(coursesList));
        System.out.println("ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList) = " + ortalamaPuanaGoreSiralaVeIlkVerilenleriAtla(coursesList, 3));
...
//1)Tüm ortalama puanların verilen sayıdan büyük olup olmadığını kontrol etmek için bir method oluşturun.
    ...
    public static boolean kelimeKursAdlarirIcindeVarmi(List<Courses> list, String kelime) {
    ...
    public static String ortalamasıEnYuksekKursunAdiniYazdir(List<Courses> list) {
